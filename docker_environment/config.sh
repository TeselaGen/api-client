...
# NOTE: If required, some of this values must be manually included in the "on_start.sh" script
...
# We set an empty token, so the jupyter notebook does not requires a password.
notebookToken=""

# The directory to use for notebooks and kernels.
# We are starting in the /home/ directory which contains the "examples" folder.
