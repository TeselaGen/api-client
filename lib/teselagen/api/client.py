...
class TeselaGenClient():
    ...
    def __init__(
        ...
        self.status_url: str = urljoin(self.host_url, f"{_module_name}/cli-api/public/status")#f"{api_url_base}/public/status"
        self.auth_url: str = urljoin(self.host_url, f"{_module_name}/cli-api/public/auth")#f"{api_url_base}/public/auth"

        # Laboratories
        self.labs_url: str = urljoin(self.host_url, "test/cli-api/laboratories")#f"{self.host_url}/test/cli-api/laboratories"
